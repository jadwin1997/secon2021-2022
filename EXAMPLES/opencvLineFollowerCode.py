...
lower = [25, 50, 0] #[25,50,0] lower bound for yellow
upper = [40, 255, 255]#[40,255,255] upper bound for yellow
...
while(True):
    ...
    if(len(contours)>1):
        ...
        if(w*h>1000):
                ...
                data = 'x'+str(_map(x,0,1280,0,62))#Just using x coordinate right now. For this purpose, I had 62 LEDs I was controlling on arduino.
    ...
    im.putpixel((x+1,y+1), ImageColor.getcolor('white', '1')) # or whatever color you wish
